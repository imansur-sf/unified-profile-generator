...
function generateProfileHTML(state) {
  ...
  const uiAccent = /^#(?:fff|ffffff)$/i.test(accent) ? '#0176D3' : accent;
...
</style><style>.sf-profile-tab{margin-left:0}</style></head>
<body>
